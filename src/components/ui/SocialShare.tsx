...
export default function SocialShare({ title, excerpt, url }: SocialShareProps) {
  ...
  const shareLinks = {
    ...
    email: `mailto:?subject=${encodeURIComponent(title)}&body=${encodedText} ${encodedUrl}`,
  };
  ...
  const socialButtons = [
    ...
    },
    {
      ...
      ariaLabel: 'Partager sur Twitter/X'
    },
    {
      name: 'LinkedIn',
      icon: <LinkedInIcon />,
    ...
    },
    {
      ...
      className: 'bg-[#D44638] hover:bg-[#c23321] text-white',
